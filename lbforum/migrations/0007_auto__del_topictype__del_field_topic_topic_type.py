...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('lbforum_forum_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('forum', models.ForeignKey(orm['lbforum.forum'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.add_column('lbforum_topic', 'topic_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lbforum.TopicType'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field groups on 'Forum'
        db.delete_table(db.shorten_name('lbforum_forum_groups'))
