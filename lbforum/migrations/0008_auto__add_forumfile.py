...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ForumFile'
        db.create_table('lbforum_forumfile', (
        ...
        db.send_create_signal('lbforum', ['ForumFile'])


    def backwards(self, orm):
        # Deleting model 'ForumFile'
        db.delete_table('lbforum_forumfile')
